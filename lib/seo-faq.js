...
export const HOMEPAGE_FAQ = [
  ...
  {
    question: 'Can I listen in Chrome without pasting?',
    answer:
      'Yes. The Chrome extension reads a selection, a long page, or a video transcript in the tab. Search the transcript, jump back or ahead, and change speed from the popup. Auto-read of new AI chat replies is optional and asked for per site.',
  },
];
