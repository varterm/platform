---
title: Varterm TTS is in the editor Extensions panel
slug: editor-extension-in-the-store
date: 2026-08-25
tags:
  - extensions
  - vscode
  - cursor
description: >-
  Install Varterm TTS from Cursor or VS Code Extensions. Auto-read the agent window, then play, pause, stop, or jump from the status bar.
excerpt: >-
  Search Varterm TTS in Extensions. Auto-read finished agent replies, and control playback without leaving the editor.
---

**Varterm TTS** is in the editor store now. You do not need a manual `.vsix` for the usual install.
...
- Want a file? [GitHub Release v0.1.62](https://github.com/varterm/extensions/releases/tag/v0.1.62) has the `.vsix`.
